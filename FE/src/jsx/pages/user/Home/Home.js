...
const Home = () => {
  ...
  const faqData = [
    {
      id: 1,
      question: "What is Fintcx Wallet?",
      answer:
        "Fintcx Wallet is a secure, easy-to-use platform for managing, sending, and receiving cryptocurrencies. It supports multiple tokens and offers advanced security features to protect your digital assets.",
    },
    {
      id: 2,
    ...
    {
      id: 3,
      question: "Is my crypto safe in Fintcx Wallet?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Fintcx Wallet supports a wide variety of cryptocurrencies, including Bitcoin, Ethereum, and many popular altcoins. Check our supported tokens list for the full range of assets you can store and manage.",
    },
    {
      id: 5,
      question: "Can I stake my crypto in Fintcx Wallet?",
      answer:
        "Yes, Fintcx Wallet offers a simple staking option that allows you to earn rewards by staking your tokens directly within the app. Just choose your desired crypto, and start staking to maximize your returns.",
    },
    {
      id: 6,
      question: "Can I connect my bank account or credit card to Fintcx Wallet?",
      answer:
        "Yes, Fintcx Wallet allows you to link your bank account or credit card for easy purchasing and transferring of cryptocurrencies. Enjoy a simple, secure way to fund your wallet and manage your assets.",
    },
  ];
            ...
            <div className="footer-inner container-xl" >
                    ...
                    <div className="widget widget_text" >
                      <div className="widget-content" >
                        ...
                        <div className="textwidget" >
                          ...
                          <p><a href="mailto:support@Fintcx.space" >support@Fintcx.space</a></p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="footer-bottom" >
                <div className="footer-credits" >
                  <p className="footer-copyright">Copyright ©2025 Fintcx. All rights reserved.
                  </p>{/* .footer-copyright */}
                </div>{/* .footer-credits */}
